...
const _pdfjsFiles = [
    ...
    'core/glyphlist.js',
    //'core/image.js', // GELT - Ignore image processing
    'core/metrics.js',
    'core/parser.js',
    'core/stream.js',
    'core/worker.js',
    //'core/jpx.js',   // GELT - Ignore image processing
    //'core/jbig2.js', // GELT - Ignore image processing
    'core/bidi.js',
    //'core/jpg.js',   // GELT - Ignore image processing
...
export default class PDFJSClass extends EventEmitter {
    ...
    parsePDFData(arrayBuffer, password) {
        ...
        // GELT - Ignore image processing entirely
        PDFJS.maxImageSize = 0;
	...
	//                Content:pdfPage.getTextContent(),
                ...
                // GELT - Avoiding this to save memory
                ...
                // GELT - Save memory by destroying the page parser
                pageParser.destroy();
	        },
	        errMsg => {
                this.raiseErrorEvent(errMsg);
                // GELT - Save memory by destroying the page parser
                pageParser.destroy();
            }
        );
